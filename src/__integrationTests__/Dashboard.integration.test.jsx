...
describe("Dashboard navigation", () => {
    ...
    const allowedTiles = Object.keys(stubRoutes).map((r) => {
        switch (r) {
        case "/board": return "manageJobs";
        case "/addjob": return "addJobListing";
        case "/fsb": return "viewJobBoard";
        case "/history": return "viewChanges";
        case "/users-roles": return "manageUsers";
