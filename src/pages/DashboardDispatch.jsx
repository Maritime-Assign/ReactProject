...
const DashboardDispatch = ({ allowedTiles }) => {
    const dashButton =
        'group w-40 h-25 sm:w-90 sm:h-50 flex flex-col items-center justify-center gap-2 rounded-md bg-mebablue-dark hover:bg-mebablue-light transition-colors duration-300 ease-in-out overflow-hidden cursor-pointer'
    ...
    return (
        <div className='w-full h-[calc(100vh-80px)] flex items-center justify-center overflow-y-hidden mx-auto'>
            <div className='w-fit flex flex-col gap-3 sm:gap-4 p-12 shadow-[0_0_10px_rgba(0,0,0,0.1)] rounded-md'>
